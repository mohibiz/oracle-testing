...
BEGIN
    ...
    VALUES(PARAM_LOG_SK ,EXECUTION_ID,'PROC_GENERATEMETDAFORRECON','RUNNING',' ',SYSDATE, SYSDATE, VAR_RECONTARGET);
    COMMIT;
	...
	END IF;
    proc_generatemetdaforrecon(VAR_EXESTRUCTURECRECON ,VAR_EXEROWCOUNTCRECON, VAR_EXEALLCOLUMNCRECON,VAR_EXECUTEtargetoracledbRECON,VAR_EXECUTEsasRECON,PARAM_LOG_SK);
    --VAR_validity:=check_object_validity( 'GUPTAMOH','PROCEDURE' , 'PROC_GENERATEMETDAFORRECON');

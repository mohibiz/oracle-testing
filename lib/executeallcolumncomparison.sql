...
prompt "executing all column comparison"
...
BEGIN
	...
	END IF;
     ...
     VALUES(LOG_SK ,EXECUTION_ID,'PROC_ALLCOLUMNCOMPARION','RUNNING',' ',SYSDATE, SYSDATE, VAR_RECONTARGET);
     COMMIT;  
    PROC_ALLCOLUMNCOMPARION(VAR_EXECUTEtargetoracledbRECON,VAR_EXECUTEsasRECON, LOG_SK);
  
    UPDATE  AR_EXECUTION_LOG SET EXECUTION_STATUS='COMPLETED' , RECON_END_DTE=SYSDATE WHERE LOG_SK=LOG_SK AND PROCEDURE_NME='PROC_ALLCOLUMNCOMPARION';
    COMMIT;
    ...
    EXCEPTION
		WHEN others THEN
            ...
            WHERE LOG_SK=LOG_SK AND PROCEDURE_NME='PROC_ALLCOLUMNCOMPARION';
    COMMIT; 
